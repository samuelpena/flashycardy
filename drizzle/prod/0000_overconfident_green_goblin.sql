CREATE TABLE "cards" (
	...
	CONSTRAINT "cards_uuid_unique" UNIQUE("uuid")
);
...
CREATE TABLE "decks" (
	...
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "decks_uuid_unique" UNIQUE("uuid")
);
--> statement-breakpoint
CREATE TABLE "study_session_cards" (
	...
	CONSTRAINT "study_session_cards_uuid_unique" UNIQUE("uuid")
);
--> statement-breakpoint
CREATE TABLE "study_sessions" (
	...
	CONSTRAINT "study_sessions_uuid_unique" UNIQUE("uuid")
);
--> statement-breakpoint
